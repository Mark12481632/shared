...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    test_error_3 = compute_test_error_mod3(test_x, test_y_3, theta, temp_parameter)
    print('Test-Error-3:',test_error_3)
    print('Theta:',theta)
    return test_error
...
def run_softmax_on_MNIST_mod3(temp_parameter=1):
    ...
    train_x, train_y, test_x, test_y = get_MNIST_data()
    train_y_3, test_y_3 = update_y(train_y, test_y)
    theta, cost_function_history = softmax_regression(train_x, train_y_3, temp_parameter, alpha= 0.3, lambda_factor = 1.0e-4, k = 10, num_iterations = 150)
    plot_cost_function_over_time(cost_function_history)
...
# print('run_softmax_on_MNIST_mod3:', run_softmax_on_MNIST_mod3())
